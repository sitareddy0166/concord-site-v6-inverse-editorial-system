...
const faqs = [
  ...
  { question: 'How far back can I claim R&D credits?', answer: 'Generally, you can amend federal returns to claim R&D credits for the past three open tax years. In some cases, state statutes may allow claims further back. Concord conducts lookback studies to identify and recover credits from prior years, so historical innovation work is not missed.' },
...
const processSteps = [
  ...
  { title: 'Technical Documentation', desc: 'We produce study reports linking each qualified activity to the four-part test, backed by contemporaneous records and project documentation.' },
  { title: 'Credit Calculation',      desc: 'We compute your benefit using both the regular and alternative simplified credit methods, then select the approach that produces the larger credit.' },
  { title: 'Filing Support',          desc: 'We prepare the tax forms and supporting schedules and coordinate filing with your CPA or tax team.' },
        ...
        <div className="arch">
          <ServiceMediaSplit
            ...
            mediaImages={[
              ...
              'https://images.unsplash.com/photo-1567427017947-545c5f8d16ad?auto=format&fit=crop&w=1000&q=85',
            ]}
